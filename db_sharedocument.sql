...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 23, 2025 lúc 07:12 AM
...
(12, 'Bài giảng Định dạng văn bản', 'Bài giảng Định dạng văn bản trình bày các nội dung về: Tổng quan, định dạng, bảng biểu, style, trộn thư, thiết lập trang, review và tiếng Việt.', '1766461022_thumb_IT3.jpg', '1766461022_BaoCaoDoAnCN.pdf', 'pdf', 5, 0, 'admin', 0, '1766461022_BaoCaoDoAnCN.pdf', 0),
(13, 'Tài liệu học tập Tin ứng dụng trong kinh doanh', 'Tài liệu \"Tin ứng dụng trong kinh doanh\" hướng dẫn sinh viên ngành TàiQuản trị kinh doanh sử dụng Excel để phân tích dữ liệu. Nội dung gồm Excel cơ bản, cơ sở dữ liệu, và các tính năng nâng cao như Goal Seek, Solver.', '1766461086_thumb_IT4.jpg', '1766461086_HuynhKhanhDuy_DeCuongChiTiet.pdf', 'pdf', 5, 0, 'admin', 0, '1766461086_HuynhKhanhDuy_DeCuongChiTiet.pdf', 0),
(14, 'Ngân hàng câu hỏi môn Linux và mã nguồn mở', 'Tài liệu về Linux và mã nguồn mở: giới thiệu khái niệm, lịch sử, lợi ích, giấy phép (Apache, BSD, GNU GPL, MIT), và các phần mềm phổ biến (Drupal, GIMP).', '1766461161_thumb_IT5.jpg', '1766461161_BaoCaoDoAnCN.pdf', 'pdf', 5, 0, 'admin', 0, '1766461161_BaoCaoDoAnCN.pdf', 0),
(15, 'Ngân hàng câu hỏi trắc nghiệm Kỹ năng sử dụng công nghệ thông tin (Cơ bản và nâng cao)', 'Ngân hàng câu hỏi trắc nghiệm Kỹ năng sử dụng công nghệ thông tin bao gồm các module từ cơ bản đến nâng cao như: Hiểu biết về CNTT cơ bản; sử dụng máy tính cơ bản; xử lý văn bản cơ bản.', '1766461235_thumb_IT6.jpg', '1766461235_HuynhKhanhDuy_DeCuongChiTiet.pdf', 'pdf', 5, 0, 'admin', 0, '1766461235_HuynhKhanhDuy_DeCuongChiTiet.pdf', 0),
...
(23, 'Bài giảng An toàn và bảo mật thông tin', 'Bài giảng về an toàn và bảo mật thông tin (ATBM TT) trong hệ thống thông tin doanh nghiệp: Khái niệm, quy trình, rủi ro, biện pháp bảo vệ và pháp luật liên quan.', '1766461827_thumb_IT13.jpg', '1766461827_BaoCaoDoAnCN.pdf', 'pdf', 8, 0, 'admin', 0, '1766461827_BaoCaoDoAnCN.pdf', 0),
...
('admin', 'Admin', '25f9e794323b453885f5181f1b624d0b', 'admin@gmail.com', 'avt5.jpg', 1, NULL, 0),
...
('khachhang1', 'Khách Hàng', 'e10adc3949ba59abbe56e057f20f883e', 'duy2912www@gmail.com', 'avt6.jpg', 0, '106649780835115078066', 0);
...
--
ALTER TABLE `documents`
  MODIFY `document_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
